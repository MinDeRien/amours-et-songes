...
screen say(who, what):
    ...
    if not renpy.variant("small"):
        add SideImage() xalign 0.0 yalign 1.15 zoom 0.5
...
screen about():
    ...
    use game_menu(_("Crédits"), scroll="viewport"):
        ...
        vbox:
            ...
            if gui.about:
                text "[gui.about!t]\n"
            text _("Ce jeu a été réalisé dans le cadre du cours de Fiction Interactive de l'UNIL\nMerci à Isaac Pante, le professeur, et à toute l'équipe d'enseignement!\n")
            text _("A Midsummer Night's Dream:\nTexte original de William SHAKESPEARE (1595-1596 (?))")
            text _("Traduction française de Jules SUPERVILLE et Jean-Louis SUPERVILLE (1956)")
            text _("Texte hors script, ajouts, adaptation: Gwenäelle BARILLON\n")
            text _("Illustrations des personnages: Gwenäelle BARILLON")
            text _("Msieur Potat (Demetrius, Helena) - outil écrit par Damien GOETSCHI (Merci!!)\n")
            text _("Images de fond réalisées par Tainara-P via IA générative, puis modifiés par mes soins")
            text _("Images des fins alternatives générées via IA génératives, puis modifiées par mes soins\n\n")
